...
class FontSettingsApp:
    ...
    def open_font_chooser(self, font_type):
        ...
        def on_select():
            ...
            current_font_size = self.selected_fonts[font_type].get().split(" ")[-1]
            new_font_string = f"{selected_font_family} {current_font_size}"
